...
class _HomePageState extends State<HomePage>
{
                ...
                children: [
                  ElevatedButton(
                      onPressed: ()
                      {
                        ...
                        {
                          AssistantMethods.readKeysForOnlinePassengers(context);
                          Navigator.of(context).push(MaterialPageRoute(builder: (c)=> SelectNearestActiveDriversScreen()),)
                              .then((value) => setState(() {}));
                        }
                      },
                      style: ElevatedButton.styleFrom(
  ...
  searchNearestOnlineDrivers() async
  {
    ...
    // await retrieveOnlinePassengersInformation(onlineNearbyAvailablePassengersList);
    //
